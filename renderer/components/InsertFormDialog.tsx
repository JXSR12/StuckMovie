import { Button, Chip, createStyles, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, FormControl, Input, InputAdornment, InputLabel, makeStyles, MenuItem, OutlinedInput, Select, Snackbar, TextField, Theme, Typography, TypographyVariant, useTheme } from "@material-ui/core";
...
export function FormItemCombo<Type>(props: {fieldname: string, value: Type, placeholder: string, options: MFOption[], handleChange: any}){
    ...
    return(
        <Autocomplete
            ...
            onChange={(event: any, newValue: MFOption) => {
...
export function FormItemMultipleChip(props: {fieldname: string, value: MFOption[], placeholder: string, options: MFOption[], handleChange: any}){
    const { fieldname, value, placeholder, options, handleChange } = props;
    ...
    return (
        <FormControl fullWidth>
            <InputLabel id="mutiple-chip-label">{fieldname}</InputLabel>
            <Select
            ...
            >
            {options.map((opt) => (
                <MenuItem key={opt.id} value={opt.label} style={getStyles(opt, options, theme)}>
                {opt.label}
                </MenuItem>
            ))}
            </Select>
